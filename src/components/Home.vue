<template>
  <div class="container">
    ...
    <p>I have rejoiced in Disneyland both with and without children, so some of my plans are based on both kinds of
      trips. I
      have been to The Happiest Place on Earth ten times since 1994, and I have rarely waited in line more than 20
      minutes, and never more than 30 minutes (except when Radiator Spring Racers broke down). I know that
      Birnbaum’s
      Guide may differ in its suggestions, so go with what you’re most comfortable with. Having said that, I am
      right.</p>
    ...
    <ul>
      ...
      <li>Some of the big rides have a “kid-switch program” (my term, not theirs) for little ones who are not big
        ...
        Then, as
        one exits the ride and takes care of the kid, the other can go on the very next cycle. Ask the ride
        operators if this is an option.
      </li>
      <li>There will be cast members throughout the parks taking pictures. If they offer, let them. You are not
        obligated to buy anything, and you can see your pictures before you decide. If you see the photographers
        but
        they don’t see you, stop them and ask them to take your picture. These are sometimes the best pictures
        you
        will get, and they make great grandparent gifts. Great places to have them take your picture are in
        front of
        the Mickey flowers, the Walt and Mickey statue or in front of Sleeping Beauty’s Castle. There is usually
        someone there to take your picture with characters as well. They will even take a picture with your
        camera
        if you want.
      </li>
